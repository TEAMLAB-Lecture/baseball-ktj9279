...
def is_validated_number(user_input_number):
    ...
    result = is_digit(user_input_number) & is_between_100_and_999(user_input_number) & not is_duplicated_number(user_input_number)
    # ==================================
    return result
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for i, user_num in enumerate(user_input_number):
        for j, random_num in enumerate(random_number):
